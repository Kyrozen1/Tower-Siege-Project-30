...
function setup(){
    ...
    base2 = new Ground(680, 300, 250, 10)
    ...
    box17 = new Box(600, 280, 30, 40)
    box18 = new Box(630, 280, 30, 40)
    box19 = new Box(660, 280, 30, 40)
    box20 = new Box(690, 280, 30, 40)
    box21 = new Box(720, 280, 30, 40)
    box22 = new Box(750, 280, 30, 40)

    box23 = new Box(630, 240, 30, 40)
    box24 = new Box(660, 240, 30, 40)
    box25 = new Box(690, 240, 30, 40)
    box26 = new Box(720, 240, 30, 40)

    box27 = new Box(660, 200, 30, 40)
    box28 = new Box(690, 200, 30, 40)

    box29 = new Box(675, 160, 30, 40)
    ...
    slingshot = new SlingShot(this.polygon,{x:130, y:400})
